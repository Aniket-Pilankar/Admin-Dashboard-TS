...
function useSidbarCompVM() {
  const { broken, collapseSidebar, collapsed, toggleSidebar, toggled } = useProSidebar();
...
const SidebarComp = () => {
  ...
  const { collapsed, handleCollapseSidebar } = useSidbarCompVM();
